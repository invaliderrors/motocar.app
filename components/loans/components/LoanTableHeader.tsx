        ...
        <CardHeader className="bg-primary text-primary-foreground p-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <CardTitle className="text-xl font-bold">Gestión de contratos</CardTitle>
                        <CardDescription className="text-primary-foreground/80">Administra los contratos y financiamientos</CardDescription>
                    </div>
                </div>
