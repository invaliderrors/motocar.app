    ...
    <div className="grid gap-3 grid-cols-2 md:grid-cols-4 lg:grid-cols-8">
      ...
      <Card className="col-span-2">
        <CardContent className="p-4">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <p className="text-xs font-medium text-muted-foreground">contratos Activos</p>
              {loading ? (
                <>
                  <Skeleton className="h-6 w-12 mt-1" />
                  <Skeleton className="h-3 w-24 mt-1" />
                ...
                <>
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5">contratos en curso</p>
                </>
              )}
            </div>
            <div className="h-10 w-10 rounded-full bg-primary/20 flex items-center justify-center">
            ...
            <div className="flex-1">
              ...
              {loading ? (
                ...
                <>
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5">contratos incumplidos</p>
                </>
              )}
            </div>
